; ModuleID = 'egSeven.c'
source_filename = "egSeven.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [4 x i8] c"ola\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  call void @printFloat(float 0x4013333340000000)
  call void @printBool(i32 1)
  call void @printString(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
  ret i32 3
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @printBool(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %3)
